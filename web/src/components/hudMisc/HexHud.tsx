...
export const HexHud: React.FC<WaveFillProps> = ({ percent, icon, color, hudKey }) => {
    ...
    return (
        <>
            <div
                ...
                className="w-[3.07288rem] h-[3.54819rem] relative overflow-hidden flex items-center justify-center"
            >
                <svg
